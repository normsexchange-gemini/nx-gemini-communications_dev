...
export const INITIAL_NORMS: Norm[] = [
  {
    id: "golden-rule-zero-hallucination",
    title: "The Golden Rule: Zero Data Invention",
    category: "Communication",
    tagline: "Inventing any type of data defeats our core purpose. We only source, verify, and relay correct reality-based data.",
    description: "Our primary mandate is finding correct data. If an entity, price, contact, or specification does not exist in the real world, we will not supply it. All AI/Agentic entities must adhere to strict verification and never hallucinate placeholder data.",
    triggerSituation: "When preparing to submit candidate batches, generate WTB matches, or update database records.",
    explicitRule: "Never invent mock data. Ensure every record has a verificationCount >= 1 before dispatching to Codex or other agents.",
    violationRemedy: "Immediate quarantine of the unverified data batch and re-execution of the sourcing scanner pipeline.",
    reciprocityIndex: 100,
    frictionRisk: "Low",
    clarityScore: 100,
    antiPatterns: [
      "Filling empty fields with 'Mock User' or random integers",
      "Bypassing the verification link health check to speed up dispatch"
    ],
    adoptionWeeks: 0,
    culturalContextNotes: "Essential for maintaining the Codex network trust boundaries.",
    votesCount: 9999,
    adoptionsCount: 9999,
    tags: ["Integrity", "DataVerification", "Codex", "GoldenRule"],
    author: {
      name: "System Architect",
      role: "Protocol Enforcer",
      avatar: "https://images.unsplash.com/photo-1555949963-aa79dcee981c?w=150&auto=format&fit=crop&q=80",
      organization: "NormsExchange Core"
    }
  },
  {
